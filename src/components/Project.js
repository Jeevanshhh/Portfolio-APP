  ...
  const projects = [
    {
      ...
      description: "A website to manage your waste.",
    ...
    },
    {
      id: 2,
      title: "MEDGENIE app",
      description: "A simple and easy excess to your healthy living.",
      link: "https://example.com",
      technologies: ["JAVA", "CLOUD", "GEN AI"],
    },
    {
      id: 3,
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <a
                href={project.link}
                target="_blank"
                className="inline-flex items-center text-red-800 hover:text-indigo-800 font-semibold transition-all duration-200"
              >
                View Project
